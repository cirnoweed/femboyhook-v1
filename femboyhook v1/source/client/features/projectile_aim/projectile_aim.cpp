...
int CAimbotProjectile::GetHitboxPriority(int nHitbox, CTFPlayer* pLocal, CTFWeaponBase* pWeapon, Target_t& target)
{
	...
	switch (nHitbox)
	{
	case 0: return bHeadshot ? 0 : 2;
	case 1: return bHeadshot ? 3 : (bLower ? 1 : 0);
	case 2: return bHeadshot ? 3 : (bLower ? 0 : 1); 
	}
